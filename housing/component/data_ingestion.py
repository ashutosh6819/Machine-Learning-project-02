...
class DataIngestion:
    ...
    def download_housing_data(self)-> str:
        try:
            ...
            # To check is there (tgz_download_dir) directory or not , if yes then do nothing if no then create one
    ...
    def extract_tgz_files(self,tgz_file_path:str):
        try:
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        try:
            ...
            self.extract_tgz_files(tgz_file_path=tgz_file_path)
